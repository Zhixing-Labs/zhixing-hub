...
export * from './modules/identity/application/phone-change.service';
export * from './modules/identity/application/platform-student-registration.service';
export * from './modules/identity/application/protocol-consent.service';
export * from './modules/identity/application/student-profile.service';
...
export * from './modules/organization/application/class-transfer.service';
export * from './modules/organization/application/counselor-student-import.service';
export * from './modules/organization/application/enterprise-organization.service';
export * from './modules/organization/application/government-organization.service';
export * from './modules/organization/application/onboarding-lead.service';
...
export * from './modules/organization/application/public-academy-admin.service';
...
export * from './modules/organization/application/university-staff.service';
